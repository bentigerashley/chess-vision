...
This is private developer tooling for a synthetic-only experiment. It receives a completed, user-calibrated chessboard after rectification; it does not replace the PWA's whole-board confirmation flow or enable recognition in the app.
